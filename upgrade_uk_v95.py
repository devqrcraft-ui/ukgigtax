...
.btn-3d-uk:hover { transform: translateY(-3px); box-shadow: 0 8px 0 #14532d, 0 15px 25px rgba(34,197,94,0.4); }
.btn-3d-uk:active { transform: translateY(2px); box-shadow: 0 2px 0 #14532d; }
</style>"""
